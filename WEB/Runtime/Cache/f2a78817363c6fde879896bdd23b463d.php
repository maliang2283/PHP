...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="<?php echo (CSS_URL); ?>/icomoon.css">
	<!-- Bootstrap  -->
	...
	<body style="background-image: url(<?php echo (IMG_URL); ?>/bg_img.jpg);">
	
	<div id="fh5co-main">
		<div class="fh5co-tab-wrap">
			<ul class="fh5co-tab-menu">
				<li class="active"><a href="#" data-tab="1"><span class="icon icon-glass"></span><span class="menu-text">介绍</span></a></li>
				<li><a href="#" data-tab="2"><span class="icon icon-graduation-cap"></span><span class="menu-text">工作</span></a></li>
				<li><a href="#" data-tab="3"><span class="icon icon-black-tie"></span><span class="menu-text">项目</span></a></li>
				<li><a href="#" data-tab="4" data-pie="yes"><span class="icon icon-fighter-jet"></span><span class="menu-text">技能</span></a></li>
			</ul>
			<div class="fh5co-tab-content active" data-content="1">
				<div class="fh5co-content-inner text-center">
					<div class="row row-bottom-padded-sm">
						<div class="col-md-12">
							<figure>
								<img src="<?php echo (IMG_URL); ?>/psb.jpg" style="border-radius:150px;width:150px;height:150px;">
							</figure>
			...
			<div class="fh5co-tab-content" data-content="4">
				<div class="fh5co-content-inner">
					<div class="row">
						<div class="col-md-12">
							<p>当你的才华还撑不起你的野心的时候，你就应该静下心来学习.</p>
						</div>
						<div class="col-md-4 col-sm-6 col-xs-12 text-center">
							<div class="chart" data-percent="80"><span><strong>React Native</strong>80%</span></div>
						</div>
						<div class="col-md-4 col-sm-6 col-xs-12 text-center">
							<div class="chart" data-percent="93"><span><strong>iOS</strong>93%</span></div>
						</div>
						<div class="col-md-4 col-sm-6 col-xs-12 text-center">
	...
	<!-- Easy PieChart -->
	<script src="<?php echo (JS_URL); ?>/jquery.easypiechart.min.js"></script>
	<!-- MAIN JS -->
